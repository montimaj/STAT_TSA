...
legend(1975, 25, legend=c("Actual", "Fitted"), col=c("Black", "Red"), lty=1:1, cex=0.5)
...
legend(1975, 4.2, legend=c("Actual", "Fitted"), col=c("Black", "Red"), lty=1:1, cex=0.5)
...
legend(1975, 20, legend=c("Actual", "Fitted"), col=c("Black", "Red"), lty=1:1, cex=0.5)
...
legend(1975, 3, legend=c("Actual", "Fitted"), col=c("Black", "Red"), lty=1:1, cex=0.5)
...
par(mfrow=c(2, 3))
# ACF, PACF, and EACF for Detrended Chemicals Data
acf(chemicals.diff2, main="ACF: Detrended Chemicals Data")
pacf(chemicals.diff2, main="PACF: Detrended Chemicals Data")
eacf(chemicals.diff2)
plot(armasubsets(chemicals.diff2, 5, 5))

# ACF, PACF, and EACF for Detrended Vehicles Data
acf(vehicles.diff2, main="ACF: Detrended Vehicles Data")
pacf(vehicles.diff2, main="PACF: Detrended Chemicals Data")
eacf(vehicles.diff2)
plot(armasubsets(vehicles.diff2, 5, 5))

# ACF, PACF, and EACF for Stabilized Chemicals Data
...
# ACF, PACF, and EACF for Stabilized Vehicles Data
acf(vehicles.bc.diff2, main="ACF: Stabilized Vehicles Data")
pacf(vehicles.bc.diff2, main="PACF: Stabilized Chemicals Data")
...
chemicals.bc.arima = auto.arima(chemicals.diff2, lambda='auto')
